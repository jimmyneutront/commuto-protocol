...
contract CommutoSwap is CommutoSwapStorage {
    ...
    */
    ...
    function proposeResolution(bytes16 swapID, uint256 makerPayout, uint256 takerPayout, uint256 confiscationPayout) public {
        ...
        uint256 totalWithoutSpentServiceFees = SafeMath.add(swaps[swapID].takenSwapAmount, SafeMath.add(totalSecurityDeposit, unspentServiceFee)); //The total amount of STBL locked up by the maker and taker, excluding service fees
